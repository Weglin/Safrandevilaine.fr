...
{foreach from=$pages item=page}
	<tr>
		...
		<td><a onclick="return confirm('Effacer ce contenu peut altérer le fonctionnement normal du site.\nEssayez de le mettre hors-ligne avant la suppression.\n\nÊtes vous sûr de vouloir de le supprimer ?');" href="{Router::url('admin/page/delete/'|cat:$page->id)}"><button>Supprimer</button></a></td>	
	</tr>
{/foreach}
</table>