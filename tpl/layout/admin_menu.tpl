<ul id="menu">
   ...
   <li><a href="{Router::url('admin/commerce/index')}">Commerces</a></li>
   <li><a href="{Router::url('admin/presse/index')}">Presse</a></li>
   <li><a href="{Router::url('admin/media/index')}">Médias</a></li>
   <li><a href="{Router::url('admin/page/index')}">Pages statiques</a></li>
   <li id="lastItem"><a href="{Router::url('')}" target="safran de vilaine">Voir le site</a></li>
</ul>
